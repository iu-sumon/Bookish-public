...
const Home = () => {
    ...
    return (
        <div>
            <div className='grid md:grid-cols-2  justify-items-center px-4 py-5 bg-[#5D97FF] width-full'>
                <div className='md:order-1 order-2'>
                    <h1 className='md:text-[38px] text-2xl text-white  mb-10'>BOOK IS A UNIQUELY PORTABLE MAGIC</h1>
                    ...
                    <Link to='/books' type="button" className="py-3 px-5 mr-2 mb-2 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-full border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700">More Collection </Link>
                </div>
                <div className='border-2 px-1 py-1 rounded-lg md:order-2 order-1'>
